...
class MIResNet(iResNet):
    def __init__(self, block, layers, **kwargs):
        ...
        self.occlusion_fsm = AttentionModule()
    ...
    def forward(self, x):
        ...
        x_non_occlusion, x_occlusion = self.occlusion_fsm(x_non_spectacles)
        x_non_facial_hair, x_facial_hair = self.facial_hair_fsm(x_non_occlusion)
